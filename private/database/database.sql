...
GRANT USAGE ON *.* TO 'simonuser'@'localhost' IDENTIFIED BY 'simonPassword';
GRANT ALL PRIVILEGES ON events_planning.* TO 'simonuser'@'localhost';
FLUSH PRIVILEGES;
USE events_planning;
...
INSERT INTO EVENT(Event_Name, Event_Description, Event_Type_Id, Start_Date, End_Date, Visibility,
    ...
    ("Thuva's Birthday Bash", "It's gonna be exciting. Please come.", 4, "2025-05-20 12:00:00", "2025-05-25 12:00:00",
    'Public', '123 Any Street', 'Ottawa', 'ON', 'K1F5D2'),
    ("Julie's Animation Conference", "Bring your own tablet.", 2, "2025-05-15 8:00:00", "2025-05-20 18:00:00",
    'Public', '854 Animation Avenue', 'Ottawa', 'ON', 'K1L9D2'),
    ("Felix's Piano Recital", "Bring your own tissues. You're gonna cry.", 3, "2025-05-16 16:00:00", "2025-05-17 21:00:00",
    'Public', '1 Elgin Street', 'Ottawa', 'ON', 'K1N8X5'),
    ("Private basketball game", "5-man teams, full-court", 1, "2025-06-11 12:00:00", "2025-06-12 15:00:00",
